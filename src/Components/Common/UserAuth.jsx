  ...
  if (isLoggedIn && user) {
    return (
      <div className="relative">
        <button className="flex items-center mt-2.5" onClick={() => setShowDropdown(!showDropdown)}>
          <FontAwesomeIcon icon={faUser} className="mr-2" />
          <span>Profile</span>
        </button>
        {showDropdown && (
          <div ref={dropdownRef} className="absolute right-0 mt-2 w-40 bg-white text-black rounded shadow-md">
            <button className="block w-full text-left p-2 hover:bg-gray-900 hover:text-cyan-100" onClick={handleProfile}>Profile</button>
